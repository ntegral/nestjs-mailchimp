...
export interface MailchimpConfigOptionsFactory {
    createMailchimpConfigOptions():
        | Promise<MailchimpConfigOptions>
        | MailchimpConfigOptions;
}

export interface MailchimpConfigAsyncOptions
    ...
    useFactory?: (
        ...args: any[]
    ) => Promise<MailchimpConfigOptions> | MailchimpConfigOptions;
}
